...
const PaymentResult = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white flex items-center justify-center text-center">
      ...
      <button
        onClick={() => navigate("/")}
        className="fixed bottom-6 right-6 px-5 py-3 text-black rounded-lg"
        style={{
          backgroundColor: "#739072",
          transition: "background-color 0.3s ease",
        }}
        onMouseEnter={(e) => (e.target.style.backgroundColor = "#5e765c")}
        onMouseLeave={(e) => (e.target.style.backgroundColor = "#739072")}
      >
        Quay về trang chủ
      </button>
    </div>
